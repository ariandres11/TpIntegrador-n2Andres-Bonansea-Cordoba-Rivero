...
void MostrarLetrasProbadas(char letras[6], int intentos);
...
void empezarJuego(char palabras[][15], char nombre[])
{
	...
	do
	{
		...
		if (intentos > 0)
			MostrarLetrasProbadas(letrasProbadas, intentos);
		dibujo(intentos);
...
void MostrarLetrasProbadas(char letras[INTENTOSGB], int intentos)
{
